...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://jmp27.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("jmp57");
        driverTrello.findElement(By.id("password")).sendKeys("Marcinkowski1!");
